$(function () {
    ...
    $("#stop").on("click", function () {
        verticalBounce.pause();
        horizontalBounce.pause();
    });

    $("#play").on("click", function () {
        verticalBounce.play();
        horizontalBounce.play();
    });

    $("#progress").on('input', function () {
        verticalBounce.seek(progress.value);
        horizontalBounce.seek(progress.value);
    });
    //
